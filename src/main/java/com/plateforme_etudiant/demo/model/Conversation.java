...
public class Conversation {
    ...
    public String getOtherParticipantName(String userId) {
        if (participant1Id.equals(userId)) return participant2Name;
    ...
    public String getParticipant1Role() { return participant1Role; }
    public void setParticipant1Role(String participant1Role) { this.participant1Role = participant1Role; }
    ...
    public String getParticipant2Role() { return participant2Role; }
    public void setParticipant2Role(String participant2Role) { this.participant2Role = participant2Role; }
